...
import {IEmpleados, IEmpleadosdetalle} from '../../../core/interfaces/empleados.interface';
...
export class EmpleadosmaestroComponent implements OnInit, OnDestroy {
    ...
    empleadosdetalle: Array<IEmpleadosdetalle>;
    empleadosSelected: IEmpleados;
    dataSource = new MatTableDataSource<IEmpleados>();
    dataSourceDetalle = new MatTableDataSource<IEmpleadosdetalle>();
    errorMessage: String;
    selectedId: number;
    edit: boolean;
    @Output() shower: EventEmitter<any> = new EventEmitter();
    @Output() detalle: EventEmitter<Array<IEmpleadosdetalle>> = new EventEmitter();
    ...
    constructor(
        ...
        private empleadosServicedetalle: EmpleadosdetalleService,
    ...
    updateEmpleadoSelected(emit?: boolean): void {
        ...
        if (emit) {
            ...
            this.detalle.emit(this.empleadosSelected ? this.empleadosSelected.movpersonal : []);
        }
    }
    ...
    viewRecorddetail(empleados: IEmpleados): void {
        ...
        this.detalle.emit(this.empleadosSelected.movpersonal);
    }
